...
<li> تحديث: بعد التنزيل والتحميل وفك الضغط إلى مجلد اسم المكون الإضافي المقابل ؛</li>",
    ...
    "admin.backup.needNoDefault"     => "لا تقم بتحديد التخزين الافتراضي للنظام كموقع النسخ الاحتياطي",
    ...
    "admin.backup.withFileDesc"      => "يدعم الإصدار المعتمد النسخ الاحتياطي المتزامن لقواعد البيانات والملفات",
