...
return array(
    ...
    "admin.setting.passwordRuleStrongMoreDesc" => "الطول أكبر من 6 ؛ يجب أن يحتوي على أرقام ؛ أحرف إنجليزية كبيرة ؛ أحرف إنجليزية صغيرة",
...
<li> نطاق IP: تطابق IP ضمن النطاق ؛ على سبيل المثال: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "بعد الحذف، سيتم نقل دليل القسم إلى سلة محذوفات النظام. هل أنت متأكد من رغبتك في المتابعة؟",
    "admin.member.memberRemoveTips"  => "بعد الحذف، سيتم نقل دليل المستخدم إلى سلة محذوفات النظام. هل أنت متأكد من رغبتك في المتابعة؟",
