...
return array(
    ...
    "admin.setting.passwordRuleStrongMoreDesc" => "ความยาวมากกว่า 6 ต้องมีตัวเลข ภาษาอังกฤษตัวพิมพ์ใหญ่ ภาษาอังกฤษตัวพิมพ์เล็ก",
...
<li> ช่วง IP: ip ตรงกันภายในช่วงตัวอย่างเช่น 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "หลังจากลบไดเร็กทอรีแผนกจะถูกย้ายไปยังถังรีไซเคิลของระบบ คุณแน่ใจหรือไม่ว่าต้องการดำเนินการต่อ",
    "admin.member.memberRemoveTips"  => "หลังจากลบแล้ว ไดเร็กทอรีผู้ใช้จะถูกย้ายไปยังถังรีไซเคิลของระบบ คุณแน่ใจหรือไม่ว่าต้องการดำเนินการต่อ",
