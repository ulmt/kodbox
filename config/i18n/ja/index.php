...
return array(
    ...
    "admin.setting.passwordRuleStrongDesc" => "長さは 6 より大きく、数字、英文字を含める必要があります",
    "admin.setting.passwordRuleStrongMoreDesc" => "長さは 6 より大きく、数字を含める必要があります。英語は大文字、英語は小文字です",
...
<li> IP範囲：IPは範囲内で一致します。例：192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "削除後、部門ディレクトリはシステムのごみ箱に移動されます。続行してもよろしいですか?",
    "admin.member.memberRemoveTips"  => "削除後、ユーザー ディレクトリはシステムのごみ箱に移動されます。続行してもよろしいですか?",
...
<li>更新：ダウンロード後、対応するプラグイン名フォルダーにアップロードして解凍します。</li>",
    ...
    "admin.storage.errNoCnt"         => "%s 物理ファイルは存在しません",
    "admin.storage.errMoveCnt"       => "%s ファイルの移動に失敗しました",
    "admin.storage.errViewLog"       => "合計 %s があります。詳細についてはログを確認してください。",
    "admin.storage.tryOrRmNow"       => "再試行をキャンセルするか、直接アンインストールすることを選択できます。",
...
拼音、最初の文字のあいまい一致をサポート",
    ...
    "explorer.secret.setUserDesc"    => "機密レベルを設定できるユーザーを指定します (同時に、該当する部門の所有者である必要があります)。",
    ...
    "explorer.secret.tips1"          => "部門のネットワーク ディスク配下のコンテンツのみ、上記の指定ユーザーが機密レベルを設定できます (同時にフォルダーの所有者である必要があります)。",
