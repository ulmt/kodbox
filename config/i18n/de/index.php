...
return array(
    ...
    "admin.setting.passwordRuleStrongDesc" => "Die Länge ist größer als 6; muss Zahlen enthalten; englische Buchstaben",
    "admin.setting.passwordRuleStrongMoreDesc" => "Länge größer als 6; muss Zahlen enthalten; Englisch in Großbuchstaben, Englisch in Kleinbuchstaben",
...
<li> IP-Bereich: IP-Übereinstimmungen innerhalb des Bereichs, z. B. 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "Nach dem Löschen wird das Abteilungsverzeichnis in den Systempapierkorb verschoben. Sind Sie sicher, dass Sie fortfahren möchten?",
    "admin.member.memberRemoveTips"  => "Nach dem Löschen wird das Benutzerverzeichnis in den Systempapierkorb verschoben. Sind Sie sicher, dass Sie fortfahren möchten?",
...
<li> Update: Laden Sie nach dem Herunterladen den entsprechenden Plug-In-Namensordner hoch und entpacken Sie ihn.</li>",
    ...
    "admin.storage.errNoCnt"         => "%s physische Dateien sind nicht vorhanden",
    ...
    "admin.storage.tryOrRmNow"       => "Sie können den erneuten Versuch abbrechen oder sich für die direkte Deinstallation entscheiden.",
 ...
 Unterstützen Sie Pinyin, Fuzzy-Matching des ersten Buchstabens",
    ...
    "explorer.secret.setUserDesc"    => "Bestimmen Sie den Benutzer, der die Vertraulichkeitsstufe festlegen kann (muss gleichzeitig Inhaber in der entsprechenden Abteilung sein)",
    ...
    "explorer.secret.tips1"          => "Nur für die Inhalte unter der Abteilungs-Netzwerkfestplatte kann der oben angegebene Benutzer die Vertraulichkeitsstufe festlegen (und muss gleichzeitig Ordnerbesitzer sein)",
