...
return array(
    ...
    "admin.setting.passwordRuleStrongMoreDesc" => "长度大于6; 必须包含数字; 大写英文; 小写英文",
...
<li>IP区间段: ip在区间内则匹配;例如:192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "删除后部门目录将移至系统回收站, 确定要继续吗？",
    "admin.member.memberRemoveTips"  => "删除后用户目录将移至系统回收站,确定要继续吗？",
