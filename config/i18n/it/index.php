...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
    ...
    "admin.backup.optionLocation"    => "Se è necessario eseguire il backup dei file, creare un nuovo spazio di archiviazione specifico per il backup",
    ...
    "admin.backup.needNoDefault"     => "Non selezionare l'archivio predefinito del sistema come posizione di backup dei file",
