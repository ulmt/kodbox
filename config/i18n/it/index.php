...
return array(
    ...
    "admin.setting.passwordRuleStrongDesc" => "La lunghezza è maggiore di 6; deve contenere numeri; lettere inglesi",
    "admin.setting.passwordRuleStrongMoreDesc" => "Lunghezza maggiore di 6; deve contenere numeri; inglese maiuscolo; inglese minuscolo",
...
<li> Intervallo IP: l'ip corrisponde all'intervallo; ad esempio: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "Dopo l'eliminazione, la directory del dipartimento verrà spostata nel cestino del sistema. Vuoi continuare?",
    "admin.member.memberRemoveTips"  => "Dopo l'eliminazione, la directory dell'utente verrà spostata nel cestino del sistema. Vuoi continuare?",
...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
    ...
    "admin.storage.errNoCnt"         => "%s file fisici non esistono",
    ...
    "admin.storage.tryOrRmNow"       => "È possibile annullare il nuovo tentativo o scegliere di disinstallare direttamente.",
 ...
 Supporta pinyin, corrispondenza fuzzy della prima lettera",
    ...
    "explorer.file.containNow"       => "attualmente contiene",
    "explorer.file.containAll"       => "contiene il totale",
    ...
    "explorer.secret.setUserDesc"    => "Specificare l'utente che può impostare il livello di riservatezza (deve essere contemporaneamente titolare nel reparto corrispondente)",
    ...
    "explorer.secret.tips1"          => "Solo per il contenuto sotto il disco di rete dipartimentale, l'utente specificato sopra può impostare il livello di riservatezza (e deve essere allo stesso tempo il proprietario della cartella)",
    ...
    "user.fileOpenClick"             => "Aprire il file (cartella) come segue",
    "user.fileOpenClick.dbclick"     => "Apri con doppio clic",
    "user.fileOpenClick.click"       => "Apri cliccando",
    ...
    "user.loginState.name"           => "dispositivo online",
    ...
    "user.menuBarAutoHide"           => "Il menu a sinistra mostra e nasconde automaticamente",
