...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
    ...
    "admin.backup.needNoDefault"     => "Non selezionare l'archivio predefinito del sistema come posizione di backup",
    ...
    "admin.backup.withFileDesc"      => "La versione autorizzata supporta il backup simultaneo di database e file",
