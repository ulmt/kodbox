...
return array(
    ...
    "admin.setting.passwordRuleStrongMoreDesc" => "La longueur est supérieure à 8 ; doit contenir des chiffres en anglais majuscule ;",
...
<li> Mise à jour: après le téléchargement, téléchargez et décompressez dans le dossier de nom de plug-in correspondant;</li>",
    ...
    "admin.backup.optionLocation"    => "Si vous devez sauvegarder des fichiers, veuillez créer un nouveau stockage spécifiquement pour la sauvegarde",
    ...
    "admin.backup.needNoDefault"     => "Ne sélectionnez pas le stockage par défaut du système comme emplacement de sauvegarde",
    ...
    "admin.backup.withFileDesc"      => "La version autorisée prend en charge la sauvegarde simultanée des bases de données et des fichiers",
