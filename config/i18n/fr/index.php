...
return array(
    ...
    "admin.setting.passwordRuleStrongDesc" => "La longueur est supérieure à 6 ; doit contenir des chiffres ; lettres anglaises",
    "admin.setting.passwordRuleStrongMoreDesc" => "Longueur supérieure à 6 ; doit contenir des chiffres ; anglais majuscule ; anglais minuscule",
...
<li> Plage IP: l'adresse IP correspond à la plage; par exemple: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "Après la suppression, le répertoire des services sera déplacé vers la corbeille du système. Êtes-vous sûr de vouloir continuer ?",
    "admin.member.memberRemoveTips"  => "Après la suppression, le répertoire des utilisateurs sera déplacé vers la corbeille du système. Êtes-vous sûr de vouloir continuer ?",
...
<li> Mise à jour: après le téléchargement, téléchargez et décompressez dans le dossier de nom de plug-in correspondant;</li>",
    ...
    "admin.storage.errNoCnt"         => "%s fichiers physiques n'existent pas",
    ...
    "admin.storage.tryOrRmNow"       => "Vous pouvez annuler la nouvelle tentative ou choisir de désinstaller directement.",
 ...
 Prise en charge du pinyin, correspondance floue de la première lettre",
    ...
    "explorer.secret.setUserDesc"    => "Spécifiez l'utilisateur qui peut définir le niveau de confidentialité (doit être le propriétaire dans le service correspondant en même temps)",
    ...
    "explorer.secret.tips1"          => "Uniquement pour le contenu sous le disque réseau départemental, l'utilisateur spécifié ci-dessus peut définir le niveau de confidentialité (et doit être le propriétaire du dossier en même temps)",
