...
return array(
    ...
    "admin.setting.passwordRuleStrongDesc" => "La longitud es mayor a 6; debe contener números; letras en inglés",
    "admin.setting.passwordRuleStrongMoreDesc" => "Longitud superior a 6; debe contener números; inglés en mayúsculas; inglés en minúsculas",
...
<li> Rango de IP: coincidencias de IP dentro del rango; por ejemplo: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "Después de la eliminación, el directorio del departamento se moverá a la papelera de reciclaje del sistema. ¿Está seguro de que desea continuar?",
    "admin.member.memberRemoveTips"  => "Después de la eliminación, el directorio de usuarios se moverá a la papelera de reciclaje del sistema. ¿Está seguro de que desea continuar?",
...
<li> Actualización: después de la descarga, cargue y descomprima en la carpeta de nombre del complemento correspondiente;</li>",
    ...
    "admin.storage.errNoCnt"         => "%s archivos físicos no existen",
    ...
    "admin.storage.tryOrRmNow"       => "Puede cancelar el reintento o elegir desinstalar directamente.",
 ...
 Admite pinyin, coincidencia difusa de la primera letra",
    ...
    "explorer.secret.setUserDesc"    => "Especifique el usuario que puede establecer el nivel de confidencialidad (debe ser el propietario en el departamento correspondiente al mismo tiempo)",
    ...
    "explorer.secret.tips1"          => "Solo para el contenido del disco de red departamental, el usuario especificado mencionado anteriormente puede establecer el nivel de confidencialidad (y debe ser el propietario de la carpeta al mismo tiempo)",
