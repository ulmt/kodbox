...
<li> Actualización: después de la descarga, cargue y descomprima en la carpeta de nombre del complemento correspondiente;</li>",
    ...
    "admin.backup.needNoDefault"     => "No seleccione el almacenamiento predeterminado del sistema como ubicación de la copia de seguridad",
    ...
    "admin.backup.withFileDesc"      => "La versión autorizada admite copias de seguridad simultáneas de bases de datos y archivos.",
