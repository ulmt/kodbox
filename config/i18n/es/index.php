...
return array(
    ...
    "admin.setting.passwordRuleStrongMoreDesc" => "La longitud es mayor que 8; debe contener números en inglés en mayúsculas;",
...
<li> Actualización: después de la descarga, cargue y descomprima en la carpeta de nombre del complemento correspondiente;</li>",
    ...
    "admin.backup.optionLocation"    => "Si necesita hacer una copia de seguridad de los archivos, cree un nuevo almacenamiento específico para la copia de seguridad.",
    ...
    "admin.backup.needNoDefault"     => "No seleccione el almacenamiento predeterminado del sistema como ubicación de copia de seguridad del archivo",
