...
<li> अपडेट: डाउनलोड करने के बाद, अपलोड करें और संबंधित प्लग-इन नाम फ़ोल्डर में अनज़िप करें;</li>",
    ...
    "admin.backup.needNoDefault"     => "बैकअप स्थान के रूप में सिस्टम डिफॉल्ट स्टोरेज का चयन न करें",
    ...
    "admin.backup.withFileDesc"      => "अधिकृत संस्करण डेटाबेस और फ़ाइलों के एक साथ बैकअप का समर्थन करता है",
