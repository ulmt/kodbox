...
return array(
    ...
    "admin.setting.passwordRuleStrongMoreDesc" => "Длина больше 6; должно содержать цифры; английский в верхнем регистре; английский в нижнем регистре",
...
<li> Диапазон IP-адресов: IP соответствует диапазону; например: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "После удаления каталог отдела будет перемещен в системную корзину. Вы уверены, что хотите продолжить?",
    "admin.member.memberRemoveTips"  => "После удаления каталог пользователя будет перемещен в системную корзину. Вы уверены, что хотите продолжить?",
