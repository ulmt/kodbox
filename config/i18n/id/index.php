...
return array(
    ...
    "admin.setting.passwordRuleStrongMoreDesc" => "Panjang lebih dari 6; harus mengandung angka; Bahasa Inggris huruf besar; Bahasa Inggris huruf kecil",
...
<li> Rentang IP: kecocokan ip dalam rentang tersebut; misalnya: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "Setelah dihapus, direktori departemen akan dipindahkan ke keranjang sampah sistem. Apakah Anda yakin ingin melanjutkan?",
    "admin.member.memberRemoveTips"  => "Setelah dihapus, direktori pengguna akan dipindahkan ke keranjang sampah sistem. Apakah Anda yakin ingin melanjutkan?",
...
<li> Perbarui: Setelah mengunduh, unggah dan unzip ke folder nama plug-in yang sesuai;</li>",
    ...
    "admin.storage.errNoCnt"         => "%s file fisik tidak ada",
    ...
    "admin.storage.tryOrRmNow"       => "Anda dapat membatalkan percobaan ulang, atau memilih untuk langsung menghapus instalasi.",
