...
<li> Dải IP: ip khớp trong dải; ví dụ: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "Sau khi xóa, thư mục phòng ban sẽ được chuyển vào thùng rác của hệ thống. Bạn có chắc chắn muốn tiếp tục không?",
    "admin.member.memberRemoveTips"  => "Sau khi xóa, thư mục người dùng sẽ được chuyển vào thùng rác của hệ thống. Bạn có chắc chắn muốn tiếp tục không?",
...
<li> Cập nhật: Sau khi tải xuống, tải lên và giải nén vào thư mục tên trình cắm tương ứng;</li>",
    ...
    "admin.storage.errNoCnt"         => "Tệp vật lý %s không tồn tại",
    ...
    "admin.storage.tryOrRmNow"       => "Bạn có thể hủy việc thử lại hoặc chọn gỡ cài đặt trực tiếp.",
 ...
 Hỗ trợ bính âm, so khớp mờ của chữ cái đầu tiên",
    ...
    "explorer.secret.setUserDesc"    => "Chỉ định người dùng có thể đặt mức độ bảo mật (phải đồng thời là chủ sở hữu trong bộ phận tương ứng)",
    ...
    "explorer.secret.tips1"          => "Chỉ đối với nội dung trong đĩa mạng của bộ phận, người dùng được chỉ định ở trên mới có thể đặt mức độ bảo mật (đồng thời phải là chủ sở hữu thư mục)",
