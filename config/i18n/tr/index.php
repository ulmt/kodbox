...
return array(
    ...
    "admin.setting.passwordRuleStrongDesc" => "Uzunluk 6'dan büyük; sayı içermelidir; İngilizce harfler",
    "admin.setting.passwordRuleStrongMoreDesc" => "Uzunluk 6'dan büyük; sayı içermelidir; İngilizce büyük harf; İngilizce küçük harf",
...
<li> IP aralığı: ip, aralık dahilinde eşleşir; örneğin: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "Silme işleminden sonra departman dizini sistemin geri dönüşüm kutusuna taşınacaktır. Devam etmek istediğinizden emin misiniz?",
    "admin.member.memberRemoveTips"  => "Silme işleminden sonra kullanıcı dizini sistemin geri dönüşüm kutusuna taşınacaktır.Devam etmek istediğinizden emin misiniz?",
...
<li> Güncelleme: İndirdikten sonra, ilgili eklenti adı klasörüne yükleyin ve açın;</li>",
    ...
    "admin.storage.errNoCnt"         => "%s fiziksel dosya mevcut değil",
    ...
    "admin.storage.tryOrRmNow"       => "Yeniden denemeyi iptal edebilir veya doğrudan kaldırmayı seçebilirsiniz.",
 ...
 İlk harfin pinyin, bulanık eşleşmesini destekleyin",
    ...
    "explorer.secret.setUserDesc"    => "Gizlilik seviyesini ayarlayabilecek kullanıcıyı belirtin (aynı zamanda ilgili departmanda sahibi olmalıdır)",
    ...
    "explorer.secret.tips1"          => "Yalnızca departman ağ diskindeki içerik için, yukarıda belirtilen kullanıcı gizlilik seviyesini belirleyebilir (ve aynı zamanda klasör sahibi olmalıdır)",
