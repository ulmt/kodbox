...
<li> Оновлення: Після завантаження завантажте та розпакуйте у відповідну папку імен плагіна;</li>",
    ...
    "admin.backup.needNoDefault"     => "Не вибирайте системне сховище за умовчанням як місце резервного копіювання",
    ...
    "admin.backup.withFileDesc"      => "Авторизована версія підтримує одночасне резервне копіювання баз даних і файлів",
