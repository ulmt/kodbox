...
return array(
    ...
    "admin.setting.passwordRuleStrongMoreDesc" => "Довжина більше 6; має містити цифри; англійська у верхньому регістрі; англійська в нижньому регістрі",
...
<li> Діапазон IP: ip відповідає діапазону; наприклад: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.groupRemoveTips"   => "Після видалення каталог відділу буде переміщено до системного кошика. Ви впевнені, що бажаєте продовжити?",
    "admin.member.memberRemoveTips"  => "Після видалення каталог користувача буде переміщено до системного кошика. Ви впевнені, що бажаєте продовжити?",
