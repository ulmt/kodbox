...
return array(
    ...
    "admin.setting.passwordRuleStrongMoreDesc" => "O comprimento é maior que 8; deve conter números em inglês maiúsculo;",
...
<li> Atualizar: Após baixar, carregue e descompacte para a pasta de nome do plug-in correspondente;</li>",
    ...
    "admin.backup.optionLocation"    => "Se você precisar fazer backup de arquivos, crie um novo armazenamento especificamente para backup",
    ...
    "admin.backup.needNoDefault"     => "Não selecione o armazenamento padrão do sistema como local de backup",
    ...
    "admin.backup.withFileDesc"      => "A versão autorizada suporta backup simultâneo de bancos de dados e arquivos",
