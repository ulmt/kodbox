...
return array(
    ...
    "admin.setting.passwordRuleStrongMoreDesc" => "6보다 큰 길이, 숫자를 포함해야 함, 대문자 영어, 소문자 영어",
...
<li> IP 범위 : ip는 범위 내에서 일치합니다 (예 : 192.168.1.1-192.168.200.255).</li>",
    ...
    "admin.member.groupRemoveTips"   => "삭제 후 부서 디렉터리는 시스템 휴지통으로 이동됩니다. 계속하시겠습니까?",
    "admin.member.memberRemoveTips"  => "삭제 후 사용자 디렉터리는 시스템 휴지통으로 이동됩니다. 계속하시겠습니까?",
